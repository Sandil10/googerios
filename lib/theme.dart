...
ThemeData googerTheme() {
  ...
  return ThemeData(
    ...
    textTheme: const TextTheme(
      ...
      titleMedium: TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: GoogerColors.text, letterSpacing: 0),
      titleSmall: TextStyle(fontSize: 14, fontWeight: FontWeight.w500, color: GoogerColors.text, letterSpacing: 0),
      bodyLarge: TextStyle(fontSize: 15, color: GoogerColors.text, letterSpacing: 0),
      bodyMedium: TextStyle(fontSize: 13, color: GoogerColors.text, letterSpacing: 0),
      bodySmall: TextStyle(fontSize: 12, color: GoogerColors.muted, letterSpacing: 0),
      labelMedium: TextStyle(fontSize: 12, fontWeight: FontWeight.w500, color: GoogerColors.muted, letterSpacing: 0),
      labelSmall: TextStyle(fontSize: 11, fontWeight: FontWeight.w500, color: GoogerColors.dim, letterSpacing: 0),
    ),
