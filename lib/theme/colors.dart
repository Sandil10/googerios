...
class AppColors {
  ...
  // Pure-black, Binance/Bybit-style surface ramp (matches flutter_app reference).
  static const bg0 = Color(0xFF000000);
  static const bg1 = Color(0xFF0C0C0F); // surface
  static const bg2 = Color(0xFF101012); // surfaceAlt
  static const bg3 = Color(0xFF141416); // surfaceRaised
  static const shopCard = Color(0xFF131316);
